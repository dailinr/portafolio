      ...
      <section className='cont-sobremi'>
        ...
        <div className='skills-sb' >
          ...
          <div>
              ...
              <img src="../public/icons8-expresar-js-50.png" alt="expressjs" width="18px" height="18px" />
              <i className='bx bxl-mongodb' style={{color: '#47A248', marginRight: 0}}></i>
              <img src="../public/icons8-postgresql-48.png" alt="postgresql" width="24px" height="24px" />
              <img src="../public/icons8-logotipo-de-java-coffee-cup-48.png" alt="java" width="26px" height="26px" />
          </div>
          ...
          <div >
              ...
              <i className='bx bxl-git' style={{color: '#F05032'}}></i>
                ...
                <img src="../public/icons8-figura-48.png" alt="figma" width="24px" height="24px" />
                <img src="../public/postman-icon.png" alt="postman" width="24px" height="24px" />
